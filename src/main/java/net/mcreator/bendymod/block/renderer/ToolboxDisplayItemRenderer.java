...
public class ToolboxDisplayItemRenderer extends GeoItemRenderer<ToolboxDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ToolboxDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
