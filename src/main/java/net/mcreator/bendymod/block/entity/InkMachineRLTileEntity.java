...
public class InkMachineRLTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public InkMachineRLTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.INK_MACHINE_RL.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(InkMachineRLBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<InkMachineRLTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<InkMachineRLTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("ink_machine_rl");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Ink Machine (RL)");
	}
