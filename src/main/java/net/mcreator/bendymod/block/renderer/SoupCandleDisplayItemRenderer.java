...
public class SoupCandleDisplayItemRenderer extends GeoItemRenderer<SoupCandleDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SoupCandleDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
