...
public class StudioChairDisplayItemRenderer extends GeoItemRenderer<StudioChairDisplayItem> {
	...
	@Override
	public RenderType getRenderType(StudioChairDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
