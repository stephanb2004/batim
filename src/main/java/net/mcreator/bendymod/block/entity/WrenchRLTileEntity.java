...
public class WrenchRLTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WrenchRLTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.WRENCH_RL.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(WrenchRLBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<WrenchRLTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<WrenchRLTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("wrench_rl");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Wrench (RL)");
	}
