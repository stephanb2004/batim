...
public class SheetHolderDisplayItemRenderer extends GeoItemRenderer<SheetHolderDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SheetHolderDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
