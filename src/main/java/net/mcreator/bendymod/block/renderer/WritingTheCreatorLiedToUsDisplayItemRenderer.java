...
public class WritingTheCreatorLiedToUsDisplayItemRenderer extends GeoItemRenderer<WritingTheCreatorLiedToUsDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WritingTheCreatorLiedToUsDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
