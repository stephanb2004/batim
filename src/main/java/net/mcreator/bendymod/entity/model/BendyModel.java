...
public class BendyModel extends GeoModel<BendyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(BendyEntity animatable, long instanceId, AnimationState animationState) {
