...
public class SammyLawrenceModel extends AnimatedGeoModel<SammyLawrenceEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(SammyLawrenceEntity animatable, int instanceId, AnimationEvent animationEvent) {
