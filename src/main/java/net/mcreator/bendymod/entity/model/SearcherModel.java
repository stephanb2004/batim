...
public class SearcherModel extends AnimatedGeoModel<SearcherEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(SearcherEntity animatable, int instanceId, AnimationEvent animationEvent) {
