...
public class HangingMicTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public HangingMicTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.HANGING_MIC.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(HangingMicBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<HangingMicTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<HangingMicTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("hanging_mic");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Hanging Mic");
	}
