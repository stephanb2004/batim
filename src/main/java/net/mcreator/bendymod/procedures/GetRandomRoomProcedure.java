	...
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		...
		if ((world.getBlockState(new BlockPos(result_x, y, result_z))).getBlock() == Blocks.AIR) {
			while (done_choosing == false) {
				...
				rarity = Mth.nextInt(RandomSource.create(), 1, 10);
				if (rarity > 0 && rarity < 5) {
					...
					if (room_variation1 == 1) {
						...
						if (chance == 1) {
							...
							room_variation2 = Mth.nextInt(RandomSource.create(), 1, 2);
							if (y == top_y_level || room_variation2 == 1) {
								done_choosing = true;
								if ((new Object() {
									public Direction getDirection(BlockState _bs) {
										Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
							...
							} else if (!(y == top_y_level) && room_variation2 == 2) {
								done_choosing = true;
								if ((new Object() {
									public Direction getDirection(BlockState _bs) {
										Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
						...
						if (big_room == true) {
							if (y == top_y_level) {
								if (BendymodModVariables.MapVariables.get(world).inkmachine_spawned == false) {
									if ((new Object() {
										public Direction getDirection(BlockState _bs) {
											Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
											if (_prop instanceof DirectionProperty _dp)
								...
								if (room_variation2 == 1 || room_variation2 == 2) {
									if ((new Object() {
										public Direction getDirection(BlockState _bs) {
											Property<?> _prop = _bs.getBlock().getStateDefinition().getProperty("facing");
											if (_prop instanceof DirectionProperty _dp)
