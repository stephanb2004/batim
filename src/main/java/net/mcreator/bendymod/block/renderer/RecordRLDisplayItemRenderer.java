...
public class RecordRLDisplayItemRenderer extends GeoItemRenderer<RecordRLDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RecordRLDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
