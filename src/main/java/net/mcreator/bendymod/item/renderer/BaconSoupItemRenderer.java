...
import net.mcreator.bendymod.item.model.BaconSoupItemModel;
import net.mcreator.bendymod.item.BaconSoupItem;
import net.mcreator.bendymod.interfaces.RendersPlayerArms;
...
public class BaconSoupItemRenderer extends GeoItemRenderer<BaconSoupItem> implements RendersPlayerArms {
	public BaconSoupItemRenderer() {
		super(new BaconSoupItemModel());
	}

	@Override
	public RenderType getRenderType(BaconSoupItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof BaconSoupItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new BaconSoupItemRenderer();
	...
	protected BaconSoupItem animatable;
	...
	@Override
	public void render(GeoModel model, BaconSoupItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(BaconSoupItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(BaconSoupItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(BaconSoupItem animatable) {
