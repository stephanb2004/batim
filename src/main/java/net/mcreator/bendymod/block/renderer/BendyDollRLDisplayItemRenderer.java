...
public class BendyDollRLDisplayItemRenderer extends GeoItemRenderer<BendyDollRLDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BendyDollRLDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
