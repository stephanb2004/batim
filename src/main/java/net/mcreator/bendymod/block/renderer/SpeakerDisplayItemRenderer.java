...
public class SpeakerDisplayItemRenderer extends GeoItemRenderer<SpeakerDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SpeakerDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
