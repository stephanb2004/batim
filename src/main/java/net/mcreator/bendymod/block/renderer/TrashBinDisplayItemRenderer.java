...
public class TrashBinDisplayItemRenderer extends GeoItemRenderer<TrashBinDisplayItem> {
	...
	@Override
	public RenderType getRenderType(TrashBinDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
