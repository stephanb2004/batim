...
import net.mcreator.bendymod.block.WalkableStudioCutWallStairsBlock;
import net.mcreator.bendymod.block.WalkableStudioCutWallSlabBlock;
import net.mcreator.bendymod.block.WalkableStudioCutWallBlock;
...
import net.mcreator.bendymod.block.StudioFloorGrateBlock;
...
import net.mcreator.bendymod.block.StudioCutWallStairsBlock;
import net.mcreator.bendymod.block.StudioCutWallSlabBlock;
import net.mcreator.bendymod.block.StudioCutWallBlock;
...
import net.mcreator.bendymod.block.SinkBlock;
import net.mcreator.bendymod.block.SignLightBlock;
import net.mcreator.bendymod.block.SignLevelPBlock;
import net.mcreator.bendymod.block.SignLevelKBlock;
import net.mcreator.bendymod.block.SignLevelABlock;
import net.mcreator.bendymod.block.SignLevel9Block;
import net.mcreator.bendymod.block.SignLevel14Block;
import net.mcreator.bendymod.block.SignLevel11Block;
...
import net.mcreator.bendymod.block.InkLayerBlock;
...
import net.mcreator.bendymod.block.EncasedInkBlock;
...
public class BendymodModBlocks {
	...
	public static final RegistryObject<Block> INKWELL = REGISTRY.register("inkwell", () -> new InkWellBlock());
	...
	public static final RegistryObject<Block> STAIRWAY_STRUCTURE_BLOCK = REGISTRY.register("stairway_structure_block", () -> new StairwayStructureBlockBlock());
	...
	public static final RegistryObject<Block> SOLID_INK = REGISTRY.register("solid_ink", () -> new SolidInkBlock());
	...
	public static final RegistryObject<Block> STIFF_STUDIO_DOOR_BASIC = REGISTRY.register("stiff_studio_door_basic", () -> new StiffStudioDoorBasicBlock());
	public static final RegistryObject<Block> STIFF_STUDIO_DOOR_SEGMENTED = REGISTRY.register("stiff_studio_door_segmented", () -> new StiffStudioDoorSegmentedBlock());
	public static final RegistryObject<Block> PAINTING_BENDY_UMBRELLA = REGISTRY.register("painting_bendy_umbrella", () -> new PaintingBendyUmbrellaBlock());
	public static final RegistryObject<Block> HEAVY_GATE_CLOSED = REGISTRY.register("heavy_gate_closed", () -> new HeavyGateClosedBlock());
	public static final RegistryObject<Block> HEAVY_GATE_OPEN = REGISTRY.register("heavy_gate_open", () -> new HeavyGateOpenBlock());
	...
	public static final RegistryObject<Block> PAINTING_BLANK = REGISTRY.register("painting_blank", () -> new PaintingBlankBlock());
	public static final RegistryObject<Block> PAINTING_BOOK = REGISTRY.register("painting_book", () -> new PaintingBookBlock());
	public static final RegistryObject<Block> PAINTING_COG = REGISTRY.register("painting_cog", () -> new PaintingCogBlock());
	public static final RegistryObject<Block> PAINTING_INKWELL = REGISTRY.register("painting_inkwell", () -> new PaintingInkwellBlock());
	public static final RegistryObject<Block> PAINTING_MUSIC = REGISTRY.register("painting_music", () -> new PaintingMusicBlock());
	public static final RegistryObject<Block> PAINTING_PLUSH = REGISTRY.register("painting_plush", () -> new PaintingPlushBlock());
	public static final RegistryObject<Block> PAINTING_WRENCH = REGISTRY.register("painting_wrench", () -> new PaintingWrenchBlock());
	public static final RegistryObject<Block> LARGE_CHAINS = REGISTRY.register("large_chains", () -> new LargeChainsBlock());
	public static final RegistryObject<Block> RECORD_RL = REGISTRY.register("record_rl", () -> new RecordRLBlock());
	public static final RegistryObject<Block> INKWELL_RL = REGISTRY.register("inkwell_rl", () -> new InkWellRLBlock());
	public static final RegistryObject<Block> GEAR = REGISTRY.register("gear", () -> new GearBlock());
	public static final RegistryObject<Block> GEAR_RL = REGISTRY.register("gear_rl", () -> new GearRLBlock());
	public static final RegistryObject<Block> BENDY_DOLL_RL = REGISTRY.register("bendy_doll_rl", () -> new BendyDollRLBlock());
	public static final RegistryObject<Block> WRENCH_RL = REGISTRY.register("wrench_rl", () -> new WrenchRLBlock());
	public static final RegistryObject<Block> ILLUSION_OF_LIVING_RL = REGISTRY.register("illusion_of_living_rl", () -> new IllusionOfLivingRLBlock());
	public static final RegistryObject<Block> PEDESTAL_ON = REGISTRY.register("pedestal_on", () -> new PedestalOnBlock());
	public static final RegistryObject<Block> PEDESTAL_RL = REGISTRY.register("pedestal_rl", () -> new PedestalRLBlock());
	public static final RegistryObject<Block> PEDESTAL_RL_ON = REGISTRY.register("pedestal_rl_on", () -> new PedestalRLOnBlock());
	public static final RegistryObject<Block> INK_MACHINE_RL = REGISTRY.register("ink_machine_rl", () -> new InkMachineRLBlock());
	public static final RegistryObject<Block> BOOK_BENDY = REGISTRY.register("book_bendy", () -> new BookBendyBlock());
	public static final RegistryObject<Block> BENDY_BOOK_STACK = REGISTRY.register("bendy_book_stack", () -> new BendyBookStackBlock());
	public static final RegistryObject<Block> REEL_BENDY_DANCE = REGISTRY.register("reel_bendy_dance", () -> new ReelBendyDanceBlock());
	public static final RegistryObject<Block> TABLE = REGISTRY.register("table", () -> new TableBlock());
	public static final RegistryObject<Block> TABLE_BIG = REGISTRY.register("table_big", () -> new TableBigBlock());
	public static final RegistryObject<Block> WALL_GASH_1 = REGISTRY.register("wall_gash_1", () -> new WallGash1Block());
	public static final RegistryObject<Block> INK_RL = REGISTRY.register("ink_rl", () -> new InkRLBlock());
	public static final RegistryObject<Block> SOLID_INK_RL = REGISTRY.register("solid_ink_rl", () -> new SolidInkRlBlock());
	public static final RegistryObject<Block> STUDIO_FLOOR_TILED = REGISTRY.register("studio_floor_tiled", () -> new StudioFloorTiledBlock());
	public static final RegistryObject<Block> STUDIO_FLOOR_TILED_STAIRS = REGISTRY.register("studio_floor_tiled_stairs", () -> new StudioFloorTiledStairsBlock());
	public static final RegistryObject<Block> STUDIO_FLOOR_TILED_SLAB = REGISTRY.register("studio_floor_tiled_slab", () -> new StudioFloorTiledSlabBlock());
	public static final RegistryObject<Block> GENT_STRUCTURE_BLOCK = REGISTRY.register("gent_structure_block", () -> new GentStructureBlockBlock());
	public static final RegistryObject<Block> INACTIVE_GENT_STRUCTURE_BLOCK = REGISTRY.register("inactive_gent_structure_block", () -> new InactiveGentStructureBlockBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_FLOOR = REGISTRY.register("walkable_studio_floor", () -> new WalkableStudioFloorBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_FLOOR_STAIRS = REGISTRY.register("walkable_studio_floor_stairs", () -> new WalkableStudioFloorStairsBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_FLOOR_SLAB = REGISTRY.register("walkable_studio_floor_slab", () -> new WalkableStudioFloorSlabBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_BLANK_WALL = REGISTRY.register("walkable_studio_blank_wall", () -> new WalkableStudioBlankWallBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_BLANK_WALL_STAIRS = REGISTRY.register("walkable_studio_blank_wall_stairs", () -> new WalkableStudioBlankWallStairsBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_BLANK_WALL_SLAB = REGISTRY.register("walkable_studio_blank_wall_slab", () -> new WalkableStudioBlankWallSlabBlock());
	...
	public static final RegistryObject<Block> DESK_OLD = REGISTRY.register("desk_old", () -> new DeskOldBlock());
	public static final RegistryObject<Block> PLANK_SHELF = REGISTRY.register("plank_shelf", () -> new PlankShelfBlock());
	public static final RegistryObject<Block> PLANK = REGISTRY.register("plank", () -> new PlankBlock());
	public static final RegistryObject<Block> STUDIO_TILES = REGISTRY.register("studio_tiles", () -> new StudioTilesBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_TILES = REGISTRY.register("walkable_studio_tiles", () -> new WalkableStudioTilesBlock());
	public static final RegistryObject<Block> STOOL = REGISTRY.register("stool", () -> new StoolBlock());
	public static final RegistryObject<Block> INK_LAYER = REGISTRY.register("ink_layer", () -> new InkLayerBlock());
	public static final RegistryObject<Block> LITTLE_MIRACLE_STATION = REGISTRY.register("little_miracle_station", () -> new LittleMiracleStationBlock());
	public static final RegistryObject<Block> RECORDING_SIGN = REGISTRY.register("recording_sign", () -> new RecordingSignBlock());
	public static final RegistryObject<Block> SOFA = REGISTRY.register("sofa", () -> new SofaBlock());
	public static final RegistryObject<Block> INDUSTRIAL_WALL_PANEL = REGISTRY.register("industrial_wall_panel", () -> new IndustrialWallPanelBlock());
	public static final RegistryObject<Block> STUDIO_FLOOR_GRATE = REGISTRY.register("studio_floor_grate", () -> new StudioFloorGrateBlock());
	public static final RegistryObject<Block> FILE_CABINET = REGISTRY.register("file_cabinet", () -> new FileCabinetBlock());
	public static final RegistryObject<Block> ENCASED_INK = REGISTRY.register("encased_ink", () -> new EncasedInkBlock());
	public static final RegistryObject<Block> GENT_VALVES = REGISTRY.register("gent_valves", () -> new GentValvesBlock());
	public static final RegistryObject<Block> CAGED_LAMP = REGISTRY.register("caged_lamp", () -> new CagedLampBlock());
	public static final RegistryObject<Block> FLOOR_PIPE = REGISTRY.register("floor_pipe", () -> new FloorPipeBlock());
	...
	public static final RegistryObject<Block> STUDIO_SWITCH_OFF = REGISTRY.register("studio_switch_off", () -> new StudioSwitchOffBlock());
	public static final RegistryObject<Block> STUDIO_SWITCH_ON = REGISTRY.register("studio_switch_on", () -> new StudioSwitchOnBlock());
	public static final RegistryObject<Block> JUMBO_BENDY_DOLL = REGISTRY.register("jumbo_bendy_doll", () -> new JumboBendyDollBlock());
	public static final RegistryObject<Block> BORIS_DOLL = REGISTRY.register("boris_doll", () -> new BorisDollBlock());
	public static final RegistryObject<Block> JUMBO_BORIS_DOLL = REGISTRY.register("jumbo_boris_doll", () -> new JumboBorisDollBlock());
	public static final RegistryObject<Block> ALICE_ANGEL_DOLL = REGISTRY.register("alice_angel_doll", () -> new AliceAngelDollBlock());
	public static final RegistryObject<Block> SINK = REGISTRY.register("sink", () -> new SinkBlock());
	public static final RegistryObject<Block> STUDIO_TOILET = REGISTRY.register("studio_toilet", () -> new StudioToiletBlock());
	public static final RegistryObject<Block> STUDIO_TV = REGISTRY.register("studio_tv", () -> new StudioTVBlock());
	public static final RegistryObject<Block> TASTY_EATS_MACHINE = REGISTRY.register("tasty_eats_machine", () -> new TastyEatsMachineBlock());
	public static final RegistryObject<Block> STUDIO_CUT_WALL = REGISTRY.register("studio_cut_wall", () -> new StudioCutWallBlock());
	public static final RegistryObject<Block> STUDIO_CUT_WALL_STAIRS = REGISTRY.register("studio_cut_wall_stairs", () -> new StudioCutWallStairsBlock());
	public static final RegistryObject<Block> STUDIO_CUT_WALL_SLAB = REGISTRY.register("studio_cut_wall_slab", () -> new StudioCutWallSlabBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_CUT_WALL = REGISTRY.register("walkable_studio_cut_wall", () -> new WalkableStudioCutWallBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_CUT_WALL_STAIRS = REGISTRY.register("walkable_studio_cut_wall_stairs", () -> new WalkableStudioCutWallStairsBlock());
	public static final RegistryObject<Block> WALKABLE_STUDIO_CUT_WALL_SLAB = REGISTRY.register("walkable_studio_cut_wall_slab", () -> new WalkableStudioCutWallSlabBlock());
	public static final RegistryObject<Block> GEARSHIFT = REGISTRY.register("gearshift", () -> new GearshiftBlock());
	public static final RegistryObject<Block> BENDY_CLOCK = REGISTRY.register("bendy_clock", () -> new BendyClockBlock());
	public static final RegistryObject<Block> STOVE = REGISTRY.register("stove", () -> new StoveBlock());
	public static final RegistryObject<Block> WRITING_I_DONT_WANT_TO_WORK_HERE_ANYMORE = REGISTRY.register("writing_i_dont_want_to_work_here_anymore", () -> new WritingIDontWantToWorkHereAnymoreBlock());
	public static final RegistryObject<Block> SIGN_LEVEL_K = REGISTRY.register("sign_level_k", () -> new SignLevelKBlock());
	public static final RegistryObject<Block> SIGN_LEVEL_11 = REGISTRY.register("sign_level_11", () -> new SignLevel11Block());
	public static final RegistryObject<Block> SIGN_LEVEL_P = REGISTRY.register("sign_level_p", () -> new SignLevelPBlock());
	public static final RegistryObject<Block> SIGN_LEVEL_9 = REGISTRY.register("sign_level_9", () -> new SignLevel9Block());
	public static final RegistryObject<Block> SIGN_LEVEL_14 = REGISTRY.register("sign_level_14", () -> new SignLevel14Block());
	public static final RegistryObject<Block> SIGN_LEVEL_A = REGISTRY.register("sign_level_a", () -> new SignLevelABlock());
