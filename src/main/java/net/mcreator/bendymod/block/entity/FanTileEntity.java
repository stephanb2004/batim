...
import net.mcreator.bendymod.block.FanBlock;

import javax.annotation.Nullable;

import java.util.stream.IntStream;

public class FanTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FanTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.FAN.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FanBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FanTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FanTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
