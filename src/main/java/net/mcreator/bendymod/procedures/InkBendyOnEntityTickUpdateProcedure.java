				...
				if (entity.getPersistentData().getBoolean("cur_inkbendy") == true) {
					...
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(
								new CommandSourceStack(CommandSource.NULL, new Vec3((x + 16), y, (z + 16)), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(), "forceload remove ~ ~ ~ ~");
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(
								new CommandSourceStack(CommandSource.NULL, new Vec3((x + 16), y, (z - 16)), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(), "forceload remove ~ ~ ~ ~");
					if (world instanceof ServerLevel _level)
					...
					if ((!world.getEntitiesOfClass(InkBendyEntity.class, AABB.ofSize(new Vec3((x + range_distance), y, (z + range_distance)), 400, 400, 400), e -> true).isEmpty()
						...
						if (((Entity) world.getEntitiesOfClass(InkBendyEntity.class,
							...
							if (((Entity) world.getEntitiesOfClass(InkBendyEntity.class, AABB
									.ofSize(new Vec3(BendymodModVariables.MapVariables.get(world).cur_inkdemon_x, BendymodModVariables.MapVariables.get(world).cur_inkdemon_y, BendymodModVariables.MapVariables.get(world).cur_inkdemon_z), 16, 16, 16),
									e -> true).stream().sorted(new Object() {
										Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
											return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
										}
								...
								if (chance == 2) {
									{
										Entity _ent = ((Entity) world.getEntitiesOfClass(InkBendyEntity.class,
												AABB.ofSize(
														new Vec3(BendymodModVariables.MapVariables.get(world).cur_inkdemon_x, BendymodModVariables.MapVariables.get(world).cur_inkdemon_y, BendymodModVariables.MapVariables.get(world).cur_inkdemon_z),
														16, 16, 16),
												e -> true).stream().sorted(new Object() {
													Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
														return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
