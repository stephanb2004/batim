...
public class RecordDisplayItemRenderer extends GeoItemRenderer<RecordDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RecordDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
