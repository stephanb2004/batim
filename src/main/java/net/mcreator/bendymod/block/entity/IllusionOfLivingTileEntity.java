...
public class IllusionOfLivingTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<IllusionOfLivingTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<IllusionOfLivingTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
