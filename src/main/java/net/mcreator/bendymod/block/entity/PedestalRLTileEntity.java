...
public class PedestalRLTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PedestalRLTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.PEDESTAL_RL.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(PedestalRLBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PedestalRLTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PedestalRLTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("pedestal_rl");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Pedestal (RL)");
	}
