...
public class BendyDollDisplayItemRenderer extends GeoItemRenderer<BendyDollDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BendyDollDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
