...
public class WritingTheSheepWillComeToSlaughterTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<WritingTheSheepWillComeToSlaughterTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<WritingTheSheepWillComeToSlaughterTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
