...
public class WritingItsTimeToBelieveTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<WritingItsTimeToBelieveTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<WritingItsTimeToBelieveTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
