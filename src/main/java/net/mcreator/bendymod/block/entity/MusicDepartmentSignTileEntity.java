...
public class MusicDepartmentSignTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<MusicDepartmentSignTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<MusicDepartmentSignTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
