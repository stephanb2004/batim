...
public class InkMachineRLDisplayItemRenderer extends GeoItemRenderer<InkMachineRLDisplayItem> {
	...
	@Override
	public RenderType getRenderType(InkMachineRLDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
