...
public class CutoutBendyDiagDisplayItemRenderer extends GeoItemRenderer<CutoutBendyDiagDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CutoutBendyDiagDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
