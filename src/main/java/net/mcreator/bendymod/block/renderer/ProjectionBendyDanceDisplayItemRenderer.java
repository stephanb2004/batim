...
public class ProjectionBendyDanceDisplayItemRenderer extends GeoItemRenderer<ProjectionBendyDanceDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ProjectionBendyDanceDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
