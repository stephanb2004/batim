...
public class WritingSingWithMeTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<WritingSingWithMeTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<WritingSingWithMeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
