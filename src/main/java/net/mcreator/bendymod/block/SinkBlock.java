...
public class SinkBlock extends Block {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(FACING)) {
			default -> Shapes.or(box(0, 0, 0, 16, 10, 9), box(0, 10, 0, 16, 16, 16));
			case NORTH -> Shapes.or(box(0, 0, 7, 16, 10, 16), box(0, 10, 0, 16, 16, 16));
			case EAST -> Shapes.or(box(0, 0, 0, 9, 10, 16), box(0, 10, 0, 16, 16, 16));
			case WEST -> Shapes.or(box(7, 0, 0, 16, 10, 16), box(0, 10, 0, 16, 16, 16));
		};
	}
