...
public class WrenchRLDisplayItemRenderer extends GeoItemRenderer<WrenchRLDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WrenchRLDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
