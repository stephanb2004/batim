...
public class InfermaryBedDisplayItemRenderer extends GeoItemRenderer<InfermaryBedDisplayItem> {
	...
	@Override
	public RenderType getRenderType(InfermaryBedDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
