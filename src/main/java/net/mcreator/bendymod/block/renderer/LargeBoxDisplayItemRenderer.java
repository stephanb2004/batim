...
public class LargeBoxDisplayItemRenderer extends GeoItemRenderer<LargeBoxDisplayItem> {
	...
	@Override
	public RenderType getRenderType(LargeBoxDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
