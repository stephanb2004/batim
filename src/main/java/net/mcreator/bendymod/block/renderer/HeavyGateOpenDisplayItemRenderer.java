...
public class HeavyGateOpenDisplayItemRenderer extends GeoItemRenderer<HeavyGateOpenDisplayItem> {
	...
	@Override
	public RenderType getRenderType(HeavyGateOpenDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
