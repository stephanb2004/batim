...
public class CoffinDisplayItemRenderer extends GeoItemRenderer<CoffinDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CoffinDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
