...
public class PedestalDisplayItemRenderer extends GeoItemRenderer<PedestalDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PedestalDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
