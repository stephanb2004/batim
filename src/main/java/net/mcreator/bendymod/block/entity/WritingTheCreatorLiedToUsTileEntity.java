...
public class WritingTheCreatorLiedToUsTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<WritingTheCreatorLiedToUsTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<WritingTheCreatorLiedToUsTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
