...
public class ProjectionBlankTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ProjectionBlankTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<ProjectionBlankTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
