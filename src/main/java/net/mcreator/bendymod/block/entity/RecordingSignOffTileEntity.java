...
public class RecordingSignOffTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<RecordingSignOffTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<RecordingSignOffTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
