...
public class RecordingSignOnDisplayItemRenderer extends GeoItemRenderer<RecordingSignOnDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RecordingSignOnDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
