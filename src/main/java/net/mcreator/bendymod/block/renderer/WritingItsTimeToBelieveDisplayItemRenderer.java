...
public class WritingItsTimeToBelieveDisplayItemRenderer extends GeoItemRenderer<WritingItsTimeToBelieveDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WritingItsTimeToBelieveDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
