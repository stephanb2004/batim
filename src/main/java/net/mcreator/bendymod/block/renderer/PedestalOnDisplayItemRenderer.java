...
public class PedestalOnDisplayItemRenderer extends GeoItemRenderer<PedestalOnDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PedestalOnDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
