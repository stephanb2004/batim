...
public class LeverPowerOffTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public LeverPowerOffTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.LEVER_POWER_OFF.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(LeverPowerOffBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<LeverPowerOffTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<LeverPowerOffTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("lever_power_off");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Power Lever");
	}
