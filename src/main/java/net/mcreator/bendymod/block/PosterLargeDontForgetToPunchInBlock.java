...
public class PosterLargeDontForgetToPunchInBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public PosterLargeDontForgetToPunchInBlock() {
		super(BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.AZALEA_LEAVES).strength(0.5f).noCollission().noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
