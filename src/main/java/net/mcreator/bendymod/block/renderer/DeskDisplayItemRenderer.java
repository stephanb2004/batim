...
public class DeskDisplayItemRenderer extends GeoItemRenderer<DeskDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DeskDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
