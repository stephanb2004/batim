...
public class JumbledPaperDisplayItemRenderer extends GeoItemRenderer<JumbledPaperDisplayItem> {
	...
	@Override
	public RenderType getRenderType(JumbledPaperDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
