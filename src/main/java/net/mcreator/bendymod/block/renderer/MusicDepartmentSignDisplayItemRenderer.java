...
public class MusicDepartmentSignDisplayItemRenderer extends GeoItemRenderer<MusicDepartmentSignDisplayItem> {
	...
	@Override
	public RenderType getRenderType(MusicDepartmentSignDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
