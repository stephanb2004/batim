...
public class PianoDisplayItemRenderer extends GeoItemRenderer<PianoDisplayItem> {
	...
	@Override
	public RenderType getRenderType(PianoDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
