...
public class InkRLBlock extends LiquidBlock {
	public InkRLBlock() {
		super(() -> BendymodModFluids.INK_RL.get(), BlockBehaviour.Properties.of().mapColor(MapColor.WATER).strength(100f).noCollission().noLootTable().liquid().pushReaction(PushReaction.DESTROY).sound(SoundType.EMPTY).replaceable());
	}
