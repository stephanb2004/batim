...
public class HangingMicDisplayItemRenderer extends GeoItemRenderer<HangingMicDisplayItem> {
	...
	@Override
	public RenderType getRenderType(HangingMicDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
