...
public class BendyBookStackTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<BendyBookStackTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<BendyBookStackTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
