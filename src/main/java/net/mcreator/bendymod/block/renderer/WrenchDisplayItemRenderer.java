...
public class WrenchDisplayItemRenderer extends GeoItemRenderer<WrenchDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WrenchDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
