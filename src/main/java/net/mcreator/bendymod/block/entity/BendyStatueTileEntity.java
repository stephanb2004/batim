...
public class BendyStatueTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BendyStatueTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.BENDY_STATUE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BendyStatueBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BendyStatueTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BendyStatueTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("bendy_statue");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Bendy Statue");
	}
