...
public class IllusionOfLivingRLTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<IllusionOfLivingRLTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<IllusionOfLivingRLTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
