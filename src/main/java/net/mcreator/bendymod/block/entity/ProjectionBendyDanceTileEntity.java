...
public class ProjectionBendyDanceTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ProjectionBendyDanceTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<ProjectionBendyDanceTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
