...
public class BorisCloneTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BorisCloneTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.BORIS_CLONE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BorisCloneBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BorisCloneTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BorisCloneTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("boris_clone");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Boris Clone");
	}
