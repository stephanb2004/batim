...
public class Cellbox2DisplayItemRenderer extends GeoItemRenderer<Cellbox2DisplayItem> {
	...
	@Override
	public RenderType getRenderType(Cellbox2DisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
