...
public class BanjoDisplayItemRenderer extends GeoItemRenderer<BanjoDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BanjoDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
