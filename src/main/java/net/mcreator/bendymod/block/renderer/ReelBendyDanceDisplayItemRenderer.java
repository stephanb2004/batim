...
public class ReelBendyDanceDisplayItemRenderer extends GeoItemRenderer<ReelBendyDanceDisplayItem> {
	...
	@Override
	public RenderType getRenderType(ReelBendyDanceDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
