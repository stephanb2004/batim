...
public class BendyDollRLTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BendyDollRLTileEntity(BlockPos pos, BlockState state) {
		super(BendymodModBlockEntities.BENDY_DOLL_RL.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BendyDollRLBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BendyDollRLTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BendyDollRLTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("bendy_doll_rl");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Bendy Doll (RL)");
	}
