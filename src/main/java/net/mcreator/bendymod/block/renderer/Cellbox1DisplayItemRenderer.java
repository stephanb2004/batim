...
public class Cellbox1DisplayItemRenderer extends GeoItemRenderer<Cellbox1DisplayItem> {
	...
	@Override
	public RenderType getRenderType(Cellbox1DisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
